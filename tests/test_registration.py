...
class TestStellarBurgersRegistration:
    ...
    def test_registration_empty_name_nothing_happens(self, driver):
        ...
        driver.find_element(*AuthRegistre.ar_email_field).send_keys('mailtest1@gmail.com')
        driver.find_element(*AuthRegistre.ar_password_field).send_keys('124567890')
    ...
    @pytest.mark.parametrize('email_list', ['mailtest1@gmailcom', 'mailtest2gmail.com', 'mail test3@gmail.com', 'test4@g mail.com',
                                            '@gmail.com', 'mailtest6@.com', 'mailtest7@gmail.'])
    def test_registration_incorrect_email_show_error(self, driver, email_list):
        ...
        driver.find_element(*AuthRegistre.ar_name_field).send_keys('Смирнова Евгения')
        driver.find_element(*AuthRegistre.ar_email_field).send_keys(email_list)
        driver.find_element(*AuthRegistre.ar_password_field).send_keys('1234567890')
